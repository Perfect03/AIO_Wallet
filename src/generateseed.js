const {
 ...
 export function _generateMnemonic() {
  ...
  export function _generatePrivateKey(_hdRootKey, _accountIndex) {
    return _hdRootKey.deriveChild(_accountIndex).privateKey;
  }
  
  export function _getPublicKey(_privateKey) {
  ...
  export function _store(_privateKey, _publicKey, _address) {
    const accountOne = {
